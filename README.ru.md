...
блокировки), неизвестные события (`SessionStart` получает пометку «контракт не
верифицирован» — он всплыл в бинарнике 1.1.1, но всё ещё не
задокументирован), стиль имени скилла, закоммиченный `installed_version.json`.
...
| [Хуки](docs/guides/hooks.md) · [RU](docs/guides/hooks.ru.md) | пять задокументированных событий (+ статус SessionStart), официальные wire-контракты, закон fail-open, матчеры, таймауты |
...
(`SessionStart`: опровергнут на 1.0.16, всплыл в бинарнике 1.1.1, контракт
всё ещё не верифицирован). Линтер его
