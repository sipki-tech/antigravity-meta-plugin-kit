...
// The five documented events. SessionStart flipped from refuted rumor to
// binary-present in CLI 1.1.1, but stays out of this list until its wire
// contract is verified by a live probe — see docs/internals.md.
  ...
  for (const ue of unknownEvents) {
    warn(
      ...
      ue.endsWith(".SessionStart")
        ? `${ue} — SessionStart appeared in the 1.1.1 binary but is ` +
          "undocumented and its wire contract is unverified (2026-07-11); " +
