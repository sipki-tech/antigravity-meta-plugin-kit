...
`SessionStart` в подвешенном состоянии: опровергнутый по бинарнику 1.0.16,
он появился в proto-поверхности бинарника 1.1.1 (2026-07-11), но всё ещё не
задокументирован, а его wire-контракт не проверен — не стройте на нём хуки
(линтер предупреждает именно с этим статусом).
