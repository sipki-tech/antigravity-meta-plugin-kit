...
Показательный случай: веб настаивал на существовании хука `SessionStart`;
бинарники это опровергают (в agy совпадения — TLS `ClientSessionStartReq`,
в приложениях — JS-жесты `onPanSessionStart`). Ранг 6 никогда не
перевешивает ранг 2.
